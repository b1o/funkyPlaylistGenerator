...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_generator_generator_component__ = __webpack_require__("../../../../../src/app/components/generator/generator.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_common_navbar_navbar_component__ = __webpack_require__("../../../../../src/app/components/common/navbar/navbar.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_8__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_15__components_generator_generator_component__["a" /* GeneratorComponent */],
            __WEBPACK_IMPORTED_MODULE_16__components_home_home_component__["a" /* HomeComponent */],
            __WEBPACK_IMPORTED_MODULE_17__components_common_navbar_navbar_component__["a" /* NavbarComponent */]
        ],
        imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_music_search_music_search_component__ = __webpack_require__("../../../../../src/app/components/music-search/music-search.component.ts");
...
var routes = [
    ...
    { path: 'auth', component: __WEBPACK_IMPORTED_MODULE_2__components_auth_auth_component__["a" /* AuthComponent */] },
    { path: 'generator', component: __WEBPACK_IMPORTED_MODULE_1__components_music_search_music_search_component__["a" /* MusicSearchComponent */] },
];
...
AppRoutingModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["M" /* NgModule */])({
        imports: [__WEBPACK_IMPORTED_MODULE_3__angular_router__["f" /* RouterModule */].forRoot(routes, { useHash: true })],
        exports: [__WEBPACK_IMPORTED_MODULE_3__angular_router__["f" /* RouterModule */]]
    })
], AppRoutingModule);
...
module.exports = "<mdb-navbar SideClass=\"navbar navbar-expand-lg navbar-dark justify-content-between\">\n  <logo>\n    <a class=\"navbar-brand\" routerLink=\"/\">Navbar</a>\n  </logo>\n  <links>\n    <ul class=\"navbar-nav ml-auto\">\n      <li mdbRippleRadius routerLinkActive=\"active\" class=\"nav-item\">\n        <a routerLink=\"/\" class=\"nav-link waves-light\">About\n        </a>\n      </li>\n      <li mdbRippleRadius routerLinkActive=\"active\" class=\"nav-item\">\n        <a routerLink=\"/generator\" class=\"nav-link waves-light\">Generator\n        </a>\n      </li>\n    </ul>\n  </links>\n</mdb-navbar>\n"
...
NavbarComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-navbar',
        template: __webpack_require__("../../../../../src/app/components/common/navbar/navbar.component.html"),
        styles: [__webpack_require__("../../../../../src/app/components/common/navbar/navbar.component.scss")]
    }),
...
module.exports = "<hr>\n<div class=\"row justify-content-center\" style=\"position:relative\">\n  <div *ngIf=\"!noResult\" class=\"result row\">\n    <div *ngFor=\"let item of result\" class=\"col-12\">\n      <app-music-card [item]=\"item\"></app-music-card>\n    </div>\n  </div>\n  <div *ngIf=\"noResult\" class=\"row justify-content-center\">\n    <span class=\"text-info text-center\">We couldn't find songs that match your sentence exactly, but here are some that might suit you</span>\n    <div class=\"col-12\">\n      <app-music-card *ngFor=\"let item of result\" [item]=\"item\"></app-music-card>\n    </div>\n  </div>\n</div>\n<hr>\n"
...
var GeneratorComponent = (function () {
    ...
    GeneratorComponent.prototype.ngOnInit = function () {
        ...
        this.generatorService.resultStream
            ...
            console.log(data);
            _this.noResult = !data.status;
            _this.result = data.songs.map(__WEBPACK_IMPORTED_MODULE_0__music_search_music_search_component__["b" /* toMusicCard */]);
        });
    };
...
var MusicSearchComponent = (function () {
    ...
    MusicSearchComponent.prototype.ngOnInit = function () {
        ...
        this.loadingSub = this.generator.generating
            .subscribe(function (isGenerating) {
            _this.showLoading = isGenerating;
        });
...
var GeneratorService = (function () {
    function GeneratorService(musicService) {
        ...
        this.generating = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["a" /* Subject */]();
        this.results = [];
                ...
                if (_this.currentIndex < _this.searchTerms.length) {
                    ...
                    for (var _b = 0, combos_1 = combos; _b < combos_1.length; _b++) {
                        ...
                        if (newSentence === _this.sentence.toLowerCase()) {
                            console.log(combo);
                            _this.generating.next(false);
                            _this.resultStream.next({ status: true, songs: combo });
                            return;
                        }
                    }
                    _this.generating.next(false);
                    _this.resultStream.next({ status: false, songs: _this.results });
    ...
    GeneratorService.prototype.getPossibleSearchTerms = function (array) {
        var result = [];
        result.push(array);
